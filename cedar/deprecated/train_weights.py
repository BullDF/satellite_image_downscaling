...
base_model = CalibrationQuantileModel().to(device)
cp_round = 1
cp_epochs = 85
load_checkpoint(base_model, cp_round, cp_epochs, device)
...
if __name__ == '__main__':
    ...
    print(f'Loading base model checkpoint from round {cp_round}, epoch {cp_epochs}')
    ...
    model = WeightedQuantileModel().to(device)
